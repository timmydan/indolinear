...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F2ED] text-[#1A1A1A] font-sans selection:bg-[#1A1A1A] selection:text-[#F5F2ED]">
      ...
      <main className="p-6 grid grid-cols-1 lg:grid-cols-4 gap-8 max-w-[1600px] mx-auto">
        {/* Main Content */}
        ...
        <aside className="lg:col-span-1">
          <div className="sticky top-24">
            <div className="border border-[#1A1A1A]/10 p-6 rounded-lg bg-white/50 backdrop-blur-sm shadow-sm max-h-[calc(100vh-8rem)] overflow-y-auto custom-scrollbar">
              <div className="flex items-center gap-2 border-b border-[#1A1A1A]/10 pb-3 mb-6">
